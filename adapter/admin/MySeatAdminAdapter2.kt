...
import com.example.retrofitdemo.admin.MainActivity3Admin
import com.example.retrofitdemo.model.SeanceItem
import kotlinx.android.synthetic.main.row_layout.view.*
class MySeatAdminAdapter2: RecyclerView.Adapter<MySeatAdminAdapter2.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { v ->
            val intent = Intent(v.context, MainActivity3Admin::class.java).apply {
