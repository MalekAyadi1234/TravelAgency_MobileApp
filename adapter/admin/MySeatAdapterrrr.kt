...
class MySeatAdapterrrr(iddd:String, dated:String): RecyclerView.Adapter<MySeatAdapterrrr.MyViewHolder>(){
    var idd=iddd
    var datee=dated
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (myList[position].disponibility){
            ...
            holder.itemView.imageChaise.setImageResource(R.drawable.ic_seat_white)
