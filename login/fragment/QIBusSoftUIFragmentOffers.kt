...
import com.example.retrofitdemo.login.QIBusSoftUIRecyclerCoverFlow
import com.example.retrofitdemo.login.adapter.QIBusSoftUINewPackageModel
import com.example.retrofitdemo.login.adapter.QIBusSoftUIPackageAdapter
...
class QIBusSoftUIFragmentOffers : Fragment(), View.OnClickListener,
    ...
    private fun getData() {
        ...
        mAdapterSoftUI = activity?.let { QIBusSoftUIPackageAdapter(it, mPackageListSoftUI!!) }
        mPopularAdapterSoftUI = activity?.let { QIBusSoftUIPackageAdapter(it, mPopularList!!) }
